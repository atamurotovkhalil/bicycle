      ...
      <div className="">
        ...
        <div className="bg-[#F57520] h-64 border flex items-center justify-around rounded-xl relative">
          ...
          <div className="w-[800px] h-[250px] overflow-hidden rounded-xl">
            <img src={vel1} className="w-[800px] h-[600px] object-cover mt-2" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 text-center">
          <div className="col-span-1 m-2">
            <div className="bg-black h-96 border rounded-xl relative">
              ...
              <div className="w-[400px] h-[280px] overflow-hidden rounded-xl flex items-start">
                <img src={vel2} className="w-[390px] h-[500px] object-cover" />
              </div>
            </div>
          </div>
          <div className="col-span-1 m-2">
            <div className="bg-black -space-x-10 h-36 border flex items-center justify-around rounded-xl relative">
              {/* Text */}
              <div>
              ...
              {/* Image Wrapper (Controls Cropping) */}
              <div className="w-[300px] h-[130px] pt-12 flex items-end justify-end overflow-hidden rounded-xl">
                <img src={vel3} className="w-[200px] h-[180px] object-cover" />
              </div>
            </div>
            <div className="bg-black -space-x-10 h-60 border flex items-center justify-around rounded-xl relative">
              {/* Text */}
              <div>
              ...
              {/* Image Wrapper (Controls Cropping) */}
              <div className="w-[300px] h-[200px] pt-12 flex items-end justify-end overflow-hidden rounded-xl">
                <img
                  src={vel4}
          ...
          <div className="col-span-1 m-2">
            ...
            <div className="bg-black -space-x-10 h-36 border flex items-center justify-around rounded-xl relative">
              ...
              {/* Image Wrapper (Controls Cropping) */}
              <div className="w-[300px] h-[130px] pt-12 flex items-end justify-end overflow-hidden rounded-xl">
                <img src={vel6} className="w-[200px] h-[180px] object-cover" />
              </div>
            </div>
          </div>
        </div>
