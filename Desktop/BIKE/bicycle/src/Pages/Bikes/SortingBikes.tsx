...
const MountainBikes = ({className}: SliderProps) => {
    // 🔹 Filter state
    ...
    useEffect(() => {
        (async () => {
            try {
                await fetchProducts(sorting, pagination.page, pagination.size);
            } catch (e) {
                console.error(e);
            }
        })()

    }, [sorting, pagination.page, pagination.size, fetchProducts]);
                                ...
                                <AccordionContent className="gap-2 text-[16px]">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <p className="border flex items-center rounded-md text-center w-32 p-1">
                                            {price.starts[0]} <FaDollarSign className="text-sm ml-1"/>
                                        </p>
                                        <span>-</span>
                                        <p className="border flex items-center rounded-md text-center w-32 p-1">
                                            {price.ends[0]} <FaDollarSign className="text-sm ml-1"/>
                                        </p>
                                    </div>
