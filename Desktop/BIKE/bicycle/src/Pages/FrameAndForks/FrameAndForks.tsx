...
const FrameAndForks = (props: Props) => {
  ...
  const fetchSpareProducts = useSparePartsStore((state: any) => state.fetchSpareProducts);
  ...
  const spares = spareProducts.filter((product: SpareProduct) =>product.category ==="frameandforks")
    ...
    <div>
      <div>
        <div
          ...
          style={{
            backgroundImage: "url('/EssentialComponents/forkframe.webp')",
          }}
        >
